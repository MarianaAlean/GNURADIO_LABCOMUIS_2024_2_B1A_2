...
class Practica2_ParteA_Punto2(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "Practica2_ParteA_Punto2")
...
def main(top_block_cls=Practica2_ParteA_Punto2, options=None):
