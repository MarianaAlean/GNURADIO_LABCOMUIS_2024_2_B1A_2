...
class Practica2_ParteB_Punto1(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "Practica2_ParteB_Punto1")
        ...
        self._fc_range = qtgui.Range(50e6, 1e9, 100e3, 200e6, 200)
        ...
        self._GTX_range = qtgui.Range(0, 30, 500e-3, 500e-3, 200)
        self._GTX_win = qtgui.RangeWidget(self._GTX_range, self.set_GTX, "Ganancia_transmisor", "counter_slider", float, QtCore.Qt.Horizontal)
...
def main(top_block_cls=Practica2_ParteB_Punto1, options=None):
